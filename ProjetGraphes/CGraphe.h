...
public:
     ...
     * \return CGraphe recopié
     *
     * Cette méthode désalloue et supprime les CSommets qui étaient présent dans les tableaux du CGraphe dans lequel on veut recopier le CGraphe passé en paramètre. De plus, les CSommets sont copiés entièrement et non juste leurs adresses.
     *
     */
    CGraphe operator=(CGraphe && GRAGraphe);
