...
public:
     ...
     *
     * Cette méthode désalloue et supprime les CArcs qui étaient présents dans les tableaux du CSommet dans lequel on veut recopier le CSommet passé en paramètre. De plus, les CArcs sont copiés entièrement et non juste leurs adresses.
     */
     ...
     *
     * \return unsigned int qui spécifie l'indice du CArc dont on souhaite récupérer la destination
     *
     */
     ...
     *
     * \param uiIndice unsigned int qui spécifie l'indice du CArc dont on souhaite récupérer la destination
     *
